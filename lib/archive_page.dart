...
import 'package:flutter_todolist_app/widgets/form_widget_sub.dart';
                      ...
                      for (var item in newList) {
                        ...
                        try {
                          http.Response response = await http.get(
                            Uri.parse (item.Url+'&stime='+time),
                          );
                          XmlDocument XmlData = XmlDocument.parse(response.body);

                          setState(() {
                            item.description = XmlData.findAllElements('hour').first.text + '시 ' + XmlData.findAllElements('time').first.text + '분 도착예정';
                          });
                        }
                        catch(e) {
                          print(e);
